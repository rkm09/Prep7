...
public class FinishTime3633 {
    public static void main(String[] args) {
        FinishTime3633 f = new FinishTime3633();
        int[] landStart = {2,8}, landDuration = {4,1}, waterStart = {6}, waterDuration = {3};
        System.out.println(f.earliestFinishTime(landStart,landDuration,waterStart,waterDuration));
    }

//    enumeration; time: O(m + n), space: O(1)
